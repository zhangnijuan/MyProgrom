...
{
    [Api("恩维协同新增企业地址薄接口")]
    [Route("/{AppKey}/{Secretkey}/{AccountID}/address/new", HttpMethods.Post, Notes = "新增企业地址薄")]
    [DataContract]
    public class NewEnterpriseAddressRequest : IReturn<EnterpriseAddressResponse>
    {
        ...
        [ApiMember(Description = "总地址(省市区详细地址拼接)",
                  ParameterType = "json", DataType = "string", IsRequired = true)]
        [DataMember(Order = 12)]
    ...
    /// </summary>
    [DataContract]
    public class EnterpriseAddressResponse
    {
        public EnterpriseAddressResponse()
        {
