...
{
    [Api("恩维协同修改企业产品接口")]
    [Route("/{AppKey}/{Secretkey}/{AccountID}/compitem/modify", HttpMethods.Post, Notes = "修改企业产品(创建采购产品:BizType=1,发布供应产品BizType=2)")]
    [DataContract]
    public class ModifyEnterpriseItemRequest : IReturn<EnterpriseItemResponse>
    {
        ...
        [ApiMember(Description = "产品状态(0 草稿 1 已发布 2 已下架 3已删除)",
                  ParameterType = "json", DataType = "int", IsRequired = true)]
        [DataMember(Order = 31)]
        public int State { get; set; }

        [ApiMember(Description = "产品状态_枚举",
                  ParameterType = "json", DataType = "string", IsRequired = true)]
        [DataMember(Order = 32)]
